...
export const GameCard2 = ({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "bg-background rounded-lg overflow-hidden shadow-xl  transition-all duration-300 transform group animate-fade-in-up flex flex-col w-40 sm:w-50",
          shadowColorClass
        )}
        style={{ animationDelay: `${animationDelay}ms`, opacity: 0 }}
      >
        <div className="relative aspect-[6/5] overflow-hidden group-hover:scale-105 transition-transform duration-300">
